      ...
      <div className="row center">
        <div className="col side-tab-panel">
          ...
          <div className="about-what" style={{textAlign: "left"}}>
            ...
            fails to reach its goal then no money will be taken nor used elsewhere.
          ...
          <div className="about-what" style={{textAlign: "left"}}>
            ...
            creation without crowdfunding are free to use for any user. 5% of money
            from crowdfunding will be taken for us given the event meets its goal, and
            5% of the money funded afterward will also be charged. If using rewards or
