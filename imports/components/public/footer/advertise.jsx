      ...
      <div>
        ...
        <div className="row">
          <div className="side-tab-panel">
            <div className="row center"><h2>Discover Promotion and Verification</h2></div>
            <div className="row center">
              <div className="about-what">
          ...
          <div className="side-tab-panel">
            <div className="row center"><h2>Opt-in Advertisement for Currency</h2></div>
            <div className="row center">
              <div className="about-what">
          ...
          <div className="side-tab-panel">
            <div className="row center"><h2>On-Site Event Advertisements</h2></div>
            <div className="row center">
              <div className="about-what">
